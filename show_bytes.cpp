...
template<> const char* type_name(const int& name)
{
    return "int";
}

template<> const char* type_name(const unsigned int& name)
{
    return "unsigned int";
}

template<> const char* type_name(const long& name)
{
    return "long";
}

template<> const char* type_name(const unsigned long& name)
{
    return "unsigned long";
}

template<> const char* type_name(const float& name)
{
    return "float";
}

template<> const char* type_name(const double& name)
{
    return "double";
}

template<> const char* type_name(const pointer_type& name)
{
    return "pointer";
}
